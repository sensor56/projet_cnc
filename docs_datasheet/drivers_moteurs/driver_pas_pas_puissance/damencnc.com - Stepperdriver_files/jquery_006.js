...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		domReady: function ( )
		{
			...
			// Assign close clicks
			$('#lightbox-overlay, #lightbox, #lightbox-loading-link, #lightbox-btnClose, #lightbox-close-button').unbind().click(function() { // bloemberg: added #lightbox-close-button, #lightbox-btnClose doesn't exist?
				$.Lightbox.finish();
				return false;	
			});
		...
		{	// Get rid of lightbox
			...
			// Hide lightbox
			$('#lightbox').stop(true,true).hide();//.stop(true,true) add to fix doubleclick issue // bloemberg
			$('#lightbox-overlay').stop().fadeOut(function() { $('#lightbox-overlay').hide(); }); //.stop() add to fix doubleclick issue // bloemberg
		...
		showImage: function ( image, step )
		{
			...
			switch ( step )
			{
				...
				case 2:
					...
					// Apply image changes
					$('#lightbox-image').attr('src', image.src); //bloemberg '../viewimage.php?file=artikeltje.jpg'); //
				...
				case 4:
					...
					$('#lightbox-caption-title a').click(function(){window.open($(this).attr("href")); return false;});
